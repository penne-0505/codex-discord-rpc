...
const FRONTMATTER_VALID = [
  ...
  "_evals/validator-fixtures/frontmatter/known/intent-schema.md",
  "_evals/validator-fixtures/frontmatter/known/qa-schema.md",
] as const;
const FRONTMATTER_INVALID = [
  ...
  "_evals/validator-fixtures/frontmatter/unknown/future-schema.md",
] as const;

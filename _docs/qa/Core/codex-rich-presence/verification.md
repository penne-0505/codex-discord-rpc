...
Python / uv CLI、payload生成、GitHub URL正規化、日本語表示、fake RPCによるRich Presence更新経路、invalid client ID時の安全な失敗、docs validatorを確認した。
...
| `uv run pytest` | PASS | 7 tests passed. |
